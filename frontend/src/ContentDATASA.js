      ...
      <div className="dashboard">
        ...
        <div className="content">
          ...
          <div className="status-box">
            <p>Data Admin Telah Ditambahkan!!</p>
            <Link to="/FurnitureListSA" className="status-button">Lihat Status Data</Link>
